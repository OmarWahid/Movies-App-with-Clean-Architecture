  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        body: const MovieTopRatedItems(),
      ),
    );
  }
}

class MovieTopRatedItems extends StatelessWidget {
  const MovieTopRatedItems({Key? key}) : super(key: key);
          ...
          return Padding(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                final movies = state.topRatedMovies[index];
                return Padding(
                  padding: EdgeInsets.only(
                    top: index == AppConstants.cD0
                        ...
                        : AppPadding.p0,
                    bottom:
                        index == state.topRatedMovies.length - AppConstants.cI1
                            ? AppPadding.p20
                            : AppPadding.p0,
                  ),
                  child: InkWell(
